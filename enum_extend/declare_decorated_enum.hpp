...
#define ENUM_EXTEND_DECLARE_1_DECORATED_TYPED_ENUM_I(NAME, ENUM_TYPE, ENUMERATIONS)\
  enum NAME : ENUM_TYPE {                                                                 \
    ENUM_EXTEND_CREATE_SEQ_FROM_1st_TUPLE2_ELEMENT(ENUMERATIONS)              \
    };                                                                           \
...
#define ENUM_EXTEND_DECLARE_1_DECORATED_TYPED_ENUM_CLASS_I(NAME, ENUM_TYPE, ENUMERATIONS)\
...
#define ENUM_EXTEND_DECLARE_2_DECORATED_TYPED_ENUM_CLASS_I(NAME, ENUM_TYPE, ENUMERATIONS)\
  enum class NAME : ENUM_TYPE {                                                                 \
    ENUM_EXTEND_CREATE_SEQ_FROM_1st_TUPLE3_ELEMENT(ENUMERATIONS)              \
  };                                                                          \
